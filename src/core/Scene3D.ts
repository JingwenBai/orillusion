...
export class Scene3D extends Object3D {
    ...
    public set envMap(value: Texture) {
        ...
        this._envMap = value;
        if (EntityCollect.instance.getSky(this) && `map` in EntityCollect.instance.getSky(this))
            EntityCollect.instance.getSky(this).map = value;
    ...
    public get exposure(): number {
        if (EntityCollect.instance.getSky(this) && `exposure` in EntityCollect.instance.getSky(this))
            return EntityCollect.instance.getSky(this).exposure as number;
        return 0;
    }
    ...
    public set exposure(value: number) {
        if (EntityCollect.instance.getSky(this) && `exposure` in EntityCollect.instance.getSky(this)) {
            EntityCollect.instance.getSky(this).exposure = value;
    ...
    public get roughness(): number {
        if (EntityCollect.instance.getSky(this) && `roughness` in EntityCollect.instance.getSky(this)) {
            return EntityCollect.instance.getSky(this).roughness as number;
        }
    }
    ...
    public set roughness(value: number) {
        if (EntityCollect.instance.getSky(this) && `roughness` in EntityCollect.instance.getSky(this)) {
            EntityCollect.instance.getSky(this).roughness = value;
        }
    }
}
