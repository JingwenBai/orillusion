...
export class Scene3D extends Object3D {
    ...
    public set envMap(value: Texture) {
        ...
        this._envMap = value;
        const _sky = EntityCollect.instance.getSky(this);
        if (_sky && `map` in _sky)
            (_sky as any).map = value;
    ...
    public get exposure(): number {
        const _sky = EntityCollect.instance.getSky(this);
        if (_sky && `exposure` in _sky) return (_sky as any).exposure as number;
        return 0;
    }
    ...
    public get roughness(): number {
        const _sky = EntityCollect.instance.getSky(this);
        if (_sky && `roughness` in _sky) return (_sky as any).roughness as number;
        return undefined;
    }
    ...
    public set roughness(value: number) {
        const _sky = EntityCollect.instance.getSky(this);
        if (_sky && `roughness` in _sky) (_sky as any).roughness = value;
    }
}
