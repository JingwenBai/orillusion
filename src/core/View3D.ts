...
export class View3D extends CEventListener {
    ...
    /**
     * The Engine3D instance that owns this view. Set automatically when the view
     * is registered via engine.startRenderView() / engine.startRenderViews().
     */
    public engine: any; // typed as `any` to avoid a circular import; actual type is Engine3D
