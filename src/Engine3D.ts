...
import * as Context3DModule from './gfx/graphics/webGpu/Context3D';
import { RTResourceMap } from './gfx/renderJob/frame/RTResourceMap';
import * as RTResourceMapModule from './gfx/renderJob/frame/RTResourceMap';

import { ForwardRenderJob } from './gfx/renderJob/jobs/ForwardRenderJob';
import { GlobalBindGroup } from './gfx/graphics/webGpu/core/bindGroups/GlobalBindGroup';
import * as GlobalBindGroupModule from './gfx/graphics/webGpu/core/bindGroups/GlobalBindGroup';
...
import * as ComponentCollectModule from './gfx/renderJob/collect/ComponentCollect';
import { ShadowLightsCollect } from './gfx/renderJob/collect/ShadowLightsCollect';
import * as ShadowLightsCollectModule from './gfx/renderJob/collect/ShadowLightsCollect';
...
export class Engine3D {
    ...
    /**
     * Per-instance sub-systems (set during init/activate)
     */
    ...
    /**
     * Activate this engine instance, setting all module-level references to this instance's sub-systems.
     * Must be called to make this instance the "current" engine used by module-level singletons.
     */
    private activate() {
        Engine3D.current = this;
        Context3DModule.webGPUContext = this.webGPUContext;
        ComponentCollectModule.componentCollect = this.componentCollect;
        GlobalBindGroupModule.globalBindGroup = this.globalBindGroup;
        RTResourceMapModule.rtResourceMap = this.rtResourceMap;
        ShadowLightsCollectModule.shadowLightsCollect = this.shadowLightsCollect;
    }
    ...
    public async init(descriptor: { canvasConfig?: CanvasConfig; beforeRender?: Function; renderLoop?: Function; lateRender?: Function, engineSetting?: EngineSetting } = {}) {
        ...
        // Activate this instance (sets all module-level references)
        this.activate();
    ...
    private async updateFrame(time: number) {
        // Ensure this instance's module-level refs are active before each frame
        this.activate();
