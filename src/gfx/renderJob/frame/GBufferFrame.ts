...
export class GBufferFrame extends RTFrame {
    ...
    /**
     * Per-engine G-buffer map, accessed via the active Engine3D instance.
     * @internal
     */
    public static get gBufferMap(): Map<string, GBufferFrame> {
        return getActiveEngine()?.gBufferMap;
    }
    ...
    /**
     * Returns (creating if needed) the GBufferFrame for the given key on the
     * currently active Engine3D instance.
     * @internal
     */
