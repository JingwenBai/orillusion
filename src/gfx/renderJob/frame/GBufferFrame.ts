...
export class GBufferFrame extends RTFrame {
    ...
    /**
     * Per-engine GBuffer map – stored on the active Engine3D instance's
     * EngineRenderMaps and accessed here via getActiveEngineRenderMaps().
     * @internal
     */
    private static get gBufferMap(): Map<string, GBufferFrame> {
        return getActiveEngineRenderMaps().gBufferMap as Map<string, GBufferFrame>;
    }
