...
/**
 * Active per-engine GBuffer map, swapped by Engine3D._activate().
 * @internal
 */
let _activeGBufferMap: Map<string, GBufferFrame> = new Map<string, GBufferFrame>();
...
export class GBufferFrame extends RTFrame {
    ...
    /**
     * Returns the active engine's GBuffer map.
     * Use Engine3D._activate() to switch between engine instances.
     * @internal
     */
    ...
    /** @internal */
    public static _setActiveMap(map: Map<string, GBufferFrame>) {
