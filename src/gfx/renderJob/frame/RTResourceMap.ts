...
export class RTResourceMap {
    ...
    // Static active instance – set by each Engine3D instance before it renders
    private static _active: RTResourceMap;

    // Per-instance render texture maps
    ...
    /** Make this instance the active one referenced by all static methods */
    public activate(): void {
        RTResourceMap._active = this;
    }

    // ---- Static backward-compat methods (delegate to the active instance) ----

    /** @deprecated Use RTResourceMap instance methods directly */
    ...
    /** Set the active RTResourceMap instance (called by Engine3D before rendering) */
