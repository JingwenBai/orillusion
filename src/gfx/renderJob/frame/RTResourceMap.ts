...
export class RTResourceMap {
    ...
    /**
     * @internal
     * Set the active RTResourceMap instance used by the currently rendering engine.
     */
    public static setCurrentInstance(instance: RTResourceMap) {
    ...
    public static WriteSplitColorTexture(id: string) {
        return this._current?.WriteSplitColorTexture(id);
    }
