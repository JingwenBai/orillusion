...
/**
 * Per-engine-instance render-target resource map.
 * Instance methods manage per-engine textures; static shims delegate to current engine.
 * @internal
 * @group Post
 */
export class RTResourceMap {
    ...
    private static _getInstance(): RTResourceMap | null {
        const Engine3D = (globalThis as any).__Engine3D__;
        return Engine3D?.current?.rtResourceMap ?? null;
    }
