...
export class RTResourceMap {
    ...
    /**
     * @internal
     * Active RTResourceMap instance for the currently rendering engine (context-switching).
     */
    public static _current: RTResourceMap = null;
    ...
    public static init() { RTResourceMap._current.init(); }
    ...
    public static WriteSplitColorTexture(id: string) {
        return RTResourceMap._current.WriteSplitColorTexture(id);
    }
