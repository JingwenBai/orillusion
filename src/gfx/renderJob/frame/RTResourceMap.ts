...
export class RTResourceMap {
    ...
    public static get rtTextureMap() { return _active?.rtTextureMap; }
    public static get rtViewQuad() { return _active?.rtViewQuad; }

    /** @deprecated Called automatically by EngineContext constructor */
    public static init() { /* no-op: instance initialized in constructor */ }
