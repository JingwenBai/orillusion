...
export class RTResourceMap {
    ...
    private static _get(): RTResourceMap {
        return getActiveEngineSubsystems().rtResourceMap as RTResourceMap;
    }

    public static get rtTextureMap(): Map<string, RenderTexture> { return RTResourceMap._get().rtTextureMap; }
    public static get rtViewQuad(): Map<string, ViewQuad> { return RTResourceMap._get().rtViewQuad; }
    ...
    public static getTexture(name: string): RenderTexture { return RTResourceMap._get().getTexture(name); }

    public static CreateSplitTexture(id: string): RenderTexture { return RTResourceMap._get().CreateSplitTexture(id); }

    public static WriteSplitColorTexture(id: string): void { RTResourceMap._get().WriteSplitColorTexture(id); }
}
