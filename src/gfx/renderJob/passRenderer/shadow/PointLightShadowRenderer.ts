...
export class PointLightShadowRenderer extends RendererBase {
        ...
        for (let si = 0; si < shadowLightCount; si++) {
            ...
            if (light.lightData.castShadowIndex > -1 && (light.needUpdateShadow || this._forceUpdate || Time.frame < 5 || light.realTimeShadow)) {
                ...
                cubeShadowMapInfo.cubeCamera.transform.updateWorldMatrix(true);
                {
                    ...
                    collectInfo = (view.engine ? view.engine.entityCollect : EntityCollect.instance).getRenderNodes(scene, cubeShadowMapInfo.cubeCamera.right_camera);
                    ...
                    collectInfo = (view.engine ? view.engine.entityCollect : EntityCollect.instance).getRenderNodes(scene, cubeShadowMapInfo.cubeCamera.left_camera);
                    ...
                    collectInfo = (view.engine ? view.engine.entityCollect : EntityCollect.instance).getRenderNodes(scene, cubeShadowMapInfo.cubeCamera.up_camera);
                    ...
                    collectInfo = (view.engine ? view.engine.entityCollect : EntityCollect.instance).getRenderNodes(scene, cubeShadowMapInfo.cubeCamera.down_camera);
                    ...
                    collectInfo = (view.engine ? view.engine.entityCollect : EntityCollect.instance).getRenderNodes(scene, cubeShadowMapInfo.cubeCamera.front_camera);
                    ...
                    collectInfo = (view.engine ? view.engine.entityCollect : EntityCollect.instance).getRenderNodes(scene, cubeShadowMapInfo.cubeCamera.back_camera);
    ...
    public drawNodes(view: View3D, camera: Camera3D, renderContext: RenderContext, nodes: RenderNode[], occlusionSystem: OcclusionSystem, clusterLightingBuffer: ClusterLightingBuffer) {
        ...
        let viewRenderList = (view.engine ? view.engine.entityCollect : EntityCollect.instance).getRenderShaderCollect(view);
        if (viewRenderList) {
