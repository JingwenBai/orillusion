...
export class ComponentCollect {
    ...
    // ---- Global pending-start queue (static) ----
    // Components added to objects before they have a view are held here.
    // Once the engine starts a frame and calls scene.waitUpdate(), each
    // component's __start() routes itself to the correct per-engine instance.
    public static waitStartComponent: Map<Object3D, IComponent[]>;
    private static _globalInit: boolean = false;
