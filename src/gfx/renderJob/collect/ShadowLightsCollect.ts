...
export class ShadowLightsCollect {
    ...
    private static _get(): ShadowLightsCollect {
        return getActiveEngineSubsystems().shadowLightsCollect as ShadowLightsCollect;
    }

    public static get maxNumDirectionShadow(): number { return ShadowLightsCollect._get().maxNumDirectionShadow; }
    public static get maxNumPointShadow(): number { return ShadowLightsCollect._get().maxNumPointShadow; }

    public static get directionLightList(): Map<Scene3D, ILight[]> { return ShadowLightsCollect._get().directionLightList; }
    public static get pointLightList(): Map<Scene3D, ILight[]> { return ShadowLightsCollect._get().pointLightList; }
    public static get shadowLights(): Map<Scene3D, Float32Array> { return ShadowLightsCollect._get().shadowLights; }

    public static init() { ShadowLightsCollect._get().init(); }
    public static createBuffer(view: View3D) { ShadowLightsCollect._get().createBuffer(view); }
    public static getShadowLightList(light: ILight) { return ShadowLightsCollect._get().getShadowLightList(light); }
    public static getShadowLightWhichScene(scene: Scene3D, type: LightType) { return ShadowLightsCollect._get().getShadowLightWhichScene(scene, type); }
    public static getDirectShadowLightWhichScene(scene: Scene3D) { return ShadowLightsCollect._get().getDirectShadowLightWhichScene(scene); }
    public static getPointShadowLightWhichScene(scene: Scene3D) { return ShadowLightsCollect._get().getPointShadowLightWhichScene(scene); }
    public static addShadowLight(light: ILight) { return ShadowLightsCollect._get().addShadowLight(light); }
    public static removeShadowLight(light: ILight) { return ShadowLightsCollect._get().removeShadowLight(light); }
    public static update(view: View3D) { ShadowLightsCollect._get().update(view); }
}
