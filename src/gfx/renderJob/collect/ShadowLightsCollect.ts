...
export class ShadowLightsCollect {
    ...
    /**
     * @internal
     * Set the active ShadowLightsCollect instance used by the currently rendering engine.
     */
    public static setCurrentInstance(instance: ShadowLightsCollect) {
        this._current = instance;
    }

    // --------------- Static proxy members/methods (delegate to active instance) ---------------
