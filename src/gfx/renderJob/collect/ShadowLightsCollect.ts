 ...
 * active Engine3D instance's shadowLightsCollect via Engine3D.current.
 * @group Lights
 */
export class ShadowLightsCollect {
    ...
    public static init() {
        Engine3D.current?.shadowLightsCollect?.init();
    }

    public static createBuffer(view: View3D) {
        Engine3D.current?.shadowLightsCollect?.createBuffer(view);
    }

    public static getShadowLightList(light: ILight): ILight[] {
        return Engine3D.current?.shadowLightsCollect?.getShadowLightList(light);
    }

    public static getShadowLightWhichScene(scene: Scene3D, type: LightType): ILight[] {
        return Engine3D.current?.shadowLightsCollect?.getShadowLightWhichScene(scene, type);
    }

    public static getDirectShadowLightWhichScene(scene: Scene3D): ILight[] {
        return Engine3D.current?.shadowLightsCollect?.getDirectShadowLightWhichScene(scene);
    }

    public static getPointShadowLightWhichScene(scene: Scene3D): ILight[] {
        return Engine3D.current?.shadowLightsCollect?.getPointShadowLightWhichScene(scene);
    }

    public static addShadowLight(light: ILight): ILight[] {
        return Engine3D.current?.shadowLightsCollect?.addShadowLight(light);
    }

    public static removeShadowLight(light: ILight): ILight[] {
        return Engine3D.current?.shadowLightsCollect?.removeShadowLight(light);
    }

    public static update(view: View3D) {
        Engine3D.current?.shadowLightsCollect?.update(view);
    }
    ...
    getShadowLightList(light: ILight): ILight[] {
    ...
    addShadowLight(light: ILight): ILight[] {
        if (!light.transform.view3D) return null;
    ...
    removeShadowLight(light: ILight): ILight[] {
