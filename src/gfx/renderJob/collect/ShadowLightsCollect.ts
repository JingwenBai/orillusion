...
export class ShadowLightsCollect {
    ...
    public static init() {
        // These maps are keyed by Scene3D object identity so entries from different
        // engines never collide.  Only allocate once; subsequent Engine3D.init()
        // calls for additional instances reuse the existing maps.
