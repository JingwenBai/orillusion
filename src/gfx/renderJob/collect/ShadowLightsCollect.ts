...
export class ShadowLightsCollect {
    ...
    /**
     * Register a ShadowLightsCollect instance as the active one for the current engine.
     * Called by Engine3D during init and before each render frame.
     */
    public static register(instance: ShadowLightsCollect) {
        ShadowLightsCollect._active = instance;
    }
    ...
    // ===== Static backward-compat constants =====

    public static maxNumDirectionShadow: number = 8;
    public static maxNumPointShadow: number = 8;
    ...
    public static init() {
        ShadowLightsCollect._active?.init();
    }
