...
export class ShadowLightsCollect {
    ...
    public static init() {
        // Maps are keyed by Scene3D so they are naturally isolated across engines.
        // Only create them once to avoid destroying live data from other engine instances.
