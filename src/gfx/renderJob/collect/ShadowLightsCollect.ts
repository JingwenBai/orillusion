...
export class ShadowLightsCollect {
    ...
    public static init() {
        // Maps are keyed by Scene3D object identity — they are shared across engines
        // without collision. Only create them on first call so subsequent engine
        // instances don't wipe data from already-running engines.
