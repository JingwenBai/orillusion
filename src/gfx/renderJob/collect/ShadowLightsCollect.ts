...
export class ShadowLightsCollect {
    ...
    public update(view: View3D) {
        ...
        // Only update camera groups belonging to this engine instance
    ...
    private static get _inst(): ShadowLightsCollect {
        return EngineRegistry.current?.shadowLightsCollect as ShadowLightsCollect;
    }

    public static init(): void {
        ShadowLightsCollect._inst?.init();
    }
    ...
    public static getShadowLightList(light: ILight): ILight[] {
        return ShadowLightsCollect._inst?.getShadowLightList(light);
    }
    ...
    public static addShadowLight(light: ILight): ILight[] {
        return ShadowLightsCollect._inst?.addShadowLight(light);
    }

    public static removeShadowLight(light: ILight): ILight[] {
        return ShadowLightsCollect._inst?.removeShadowLight(light);
    }
