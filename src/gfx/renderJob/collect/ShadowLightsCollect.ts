...
export class ShadowLightsCollect {
    ...
    public static get active(): ShadowLightsCollect {
        if (!this._active) {
    ...
    public static createBuffer(view: View3D) {
        return this.active.createBuffer(view);
    }

    static getShadowLightList(light: ILight) {
        return this.active.getShadowLightList(light);
    }

    static getShadowLightWhichScene(scene: Scene3D, type: LightType) {
        return this.active.getShadowLightWhichScene(scene, type);
    }

    static getDirectShadowLightWhichScene(scene: Scene3D) {
        return this.active.getDirectShadowLightWhichScene(scene);
    }

    static getPointShadowLightWhichScene(scene: Scene3D) {
        return this.active.getPointShadowLightWhichScene(scene);
    }

    static addShadowLight(light: ILight) {
        return this.active.addShadowLight(light);
    }

    public static removeShadowLight(light: ILight) {
        return this.active.removeShadowLight(light);
    }

    public static update(view: View3D) {
        return this.active.update(view);
    }
