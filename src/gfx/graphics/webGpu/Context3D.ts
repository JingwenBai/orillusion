...
export class Context3D extends CEventDispatcher {
    ...
    // Shared GPU adapter and device across all engine instances (initialized once)
    ...
    async init(canvasConfig?: CanvasConfig): Promise<boolean> {
        ...
        // configure webgpu context (per-engine canvas)
...
/**
 * Switch the active WebGPU context to the given engine instance's context.
