...
/**
 * The currently active WebGPU context. Swapped by each Engine3D instance before
 * its render frame so that all sub-systems always reference the right device/canvas.
 * @internal
 */
