 ...
 * Each Engine3D owns a Context3D and switches this reference before rendering its frame,
 * which lets all subsystems continue using `webGPUContext` without knowing which engine is active.
 * @internal
 */
