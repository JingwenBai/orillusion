...
/**
 * @internal
 * The currently active WebGPU context. Updated by Engine3D before each frame.
 */
export let webGPUContext: Context3D;

/**
 * @internal
 * Switch the active WebGPU context. Called by Engine3D when activating an engine instance.
 */
