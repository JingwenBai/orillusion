...
export let _activeGlobalBindGroup: GlobalBindGroup | null = null;
export function setActiveGlobalBindGroup(g: GlobalBindGroup): void {
    _activeGlobalBindGroup = g;
}
...
export class GlobalBindGroup {
    ...
    public static get modelMatrixBindGroup(): MatrixBindGroup { return _activeGlobalBindGroup?.modelMatrixBindGroup; }
    public static getLightEntries(scene: Scene3D): LightEntries { return _activeGlobalBindGroup?.getLightEntries(scene); }
    public static getReflectionEntries(scene: Scene3D): ReflectionEntries { return _activeGlobalBindGroup?.getReflectionEntries(scene); }
    public static getCameraGroup(camera: Camera3D) { return _activeGlobalBindGroup?.getCameraGroup(camera); }
    public static updateCameraGroup(camera: Camera3D) { return _activeGlobalBindGroup?.updateCameraGroup(camera); }
    public static getAllCameraGroup() { return _activeGlobalBindGroup?.getAllCameraGroup(); }
}
