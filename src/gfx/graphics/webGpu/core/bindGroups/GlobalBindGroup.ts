...
export class GlobalBindGroup {
    ...
    public static get modelMatrixBindGroup() { return _active?.modelMatrixBindGroup; }

    /** @deprecated GPU resources are now initialized in EngineContext.initGPU() */
    public static init() { /* no-op: handled by EngineContext.initGPU() */ }
