...
export class GlobalBindGroup {
    ...
    /**
     * Register a GlobalBindGroup instance as the active one for the current engine.
     * Called by Engine3D during init and before each render frame.
     */
    public static register(instance: GlobalBindGroup) {
