...
export class RenderNode extends ComponentBase {
    ...
    public onEnable(): void {
        ...
        this.transform.view3D?.engine?.entityCollect?.addRenderNode(this.transform.scene3D, this);
    ...
    public onDisable(): void {
        this._enable = false;
        this.transform.view3D?.engine?.entityCollect?.removeRenderNode(this.transform.scene3D, this);
        super.onDisable?.();
    }
